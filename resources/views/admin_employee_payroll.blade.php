...
<head>
    ...
    <title>Admin Employee Payroll Page</title>
...
<body>
    ...
    <div class="row"> 
        <a class="user_type_btn_employee" id="active" href="admin_user">
            ALL 
            <p class="total_value">(63)</p>
        </a>
        <a class="user_type_btn_employee" href="admin_customer">
            CUSTOMER 
            <p class="total_value">(63)</p>
        </a>
        <a class="user_type_btn_employee" href="admin_cleaner">
            CLEANER 
            <p class="total_value">(63)</p>
        </a>
    </div>
            ...
            <table class="table user_table" id="user_table">
                <thead>
                    <tr class="user_table_row">
                        ...
                        <th class="text-center user_table_header">Total Days Present</th>
                        <th class="text-center user_table_header">Rate</th>
                        <th class="text-center user_table_header">Total Salary</th>
                    </tr>
                </thead>
                <tbody>
                    <tr class="user_table_row">
