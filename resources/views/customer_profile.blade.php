...
<body>
    ...
    <div class="col-2 d-flex customer_profile_title_con">
        <div>
            <h1 class="customer_cards_title">My Profile</h1> 
        </div>
    </div>
    <div class="d-flex">
        ...
        <div class="d-flex flex-column">
            <div class="p-2 customer_profile_name_con">
                <h2 class="customer_profile_name">Lyka C. Casilao</h2>
            </div>
            <div class="d-flex p-3 customer_profile_info_con">
                <div class="customer_profile_info_icon">
                    <i class="bi bi-person-fill"></i>
                </div>
                <h5 class="customer_profile_info">lycasilao@gbox.adnu.edu.ph</h5>
            </div>
            <div class="d-flex p-3 customer_profile_info_con">
                <div class="customer_profile_info_icon">
                    <i class="bi bi-telephone"></i>
                </div>
                <h5 class="customer_profile_info">09083095858</h5>
            </div>
            <div class="d-flex p-3 customer_profile_info_con">
                <div class="customer_profile_info_icon">
                    <i class="bi bi-house-door-fill"></i>
                </div>
                <h5 class="customer_profile_info">Pacol, Naga City</h5>
            </div>
        </div>
