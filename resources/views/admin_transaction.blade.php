...
<header> <!-- Navbar -->
    ...
    <div class="row user_btn_con"> <!-- Sub Header -->  
        <a class="user_type_btn active_sub"  href="admin_transaction">
            TRANSACTION 
            <p class="total_value">
                ()
            </p>
                ...
                <div class="card card_transaction p-4">
                    ...
                    <div> 
                        <h6 class="booking_date">
                            <b>Desired Schedule:</b> {{ date('F d, Y', strtotime($value->schedule_date)) }} {{ date('h:i A', strtotime($value->schedule_time)) }} </h6>
                    </div>
                    <div>
                        ...
                        <div class="modal fade" id="exampleModalLong10" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true"> <!-- Modal -->
                            ...
                            <div class="modal-content p-3 trans_modal_content"> <!-- Modal Content-->
                                ...
                                <div class="modal-footer trans_modal_footer">
                                    <button type="button" class="btn btn-primary accept_btn" data-dismiss="modal" data-toggle="modal" data-target="#exampleModalLong101">
                                        ACCEPT
                                    </button>
                                    <button form="myform" type="submit" class="btn btn-primary decline_btn" name="status" value="Decline">
                                        DECLINE
                                    </button>
                                </div>
